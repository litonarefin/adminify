 ...
 * -----------------------------------------------------------
 *
 * Adminify Framework Gutenberg Block
...
( function( blocks, blockEditor, element, components ) {
	...
	if ( ! window.adminify_gutenberg_blocks ) {
		return; }

	Object.values( window.adminify_gutenberg_blocks ).forEach(
		function( block ) {
			...
			registerBlockType(
				block.name,
				{
					...
					edit: function (props) {
						...
						createElement(
							'div',
							{className: 'adminify-shortcode-block'},
							createElement(
								Button,
								{
									'data-modal-id': block.modal_id,
									'data-gutenberg-id': block.name,
									className: 'is-secondary adminify-shortcode-button',
									onClick: function () {
										window.adminify_gutenberg_props = props;
									},
								},
								block.button_title
							),
