	...
	class ADMINIFY_Field_typography extends ADMINIFY_Fields {
		...
		public function render() {
			...
			if ( ! empty( $args['backup_font_family'] ) ) {
				...
				echo Utils::wp_kses_custom($this->create_select(
					apply_filters(
			...
			if ( ! empty( $args['font_weight'] ) || ! empty( $args['font_style'] ) ) {
				...
				echo '<option value="">' . ( ! $this->chosen ? esc_html__( 'Default', 'adminify' ) : '' ) . '</option>';
				...
				if ( ! empty( $args['extra_styles'] ) ) {
					...
					echo Utils::wp_kses_custom($this->create_select( $this->value['extra-styles'], 'extra-styles', $placeholder, true ));
					echo '</div>';
				}
			...
			if ( ! empty( $args['subset'] ) ) {
				...
				echo Utils::wp_kses_custom($this->create_select( $subset, 'subset', esc_html__( 'Default', 'adminify' ), $args['multi_subset'] ));
				echo '</div>';
			}
