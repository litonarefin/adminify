	...
	<div class="fs-modal-dialog">
		...
		<div class="fs-modal-body">
			...
			<?php if ( $require_credentials ) : ?>
				<div id="request-filesystem-credentials-dialog">
					<?php echo Utils::wp_kses_custom($credentials_form); ?>
				</div>
			<?php else : ?>
				<p class="fs-installation-notice">
				<?php
				echo sprintf(
		...
		<div class="fs-modal-footer">
			...
			<button
				...
				button-cancel"><?php fs_esc_html_echo_inline( 'Cancel Installation', 'cancel-installation', $slug ); ?><?php if ( ! $require_credentials ) : ?>
				(<?php echo wp_kses_post( $countdown_html ); ?>)<?php endif ?></button>
			<button
