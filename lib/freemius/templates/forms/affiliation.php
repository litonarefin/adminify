					...
					<div id="messages">
						...
						<?php if ( $is_affiliate ) : ?>
							...
							<?php else : ?>
									...
									?>
									<div class="<?php echo esc_attr($message_container_class); ?>">
							...
							<div id="application_form_container" <?php echo ( $is_pending_affiliate ) ? '' : 'style="display: none"'; ?>>
								...
								<form>
									...
									<div class="input-container input-container-text">
										...
										<input id="full_name" type="text" value="<?php echo esc_attr( $full_name ); ?>" class="regular-text" <?php echo esc_attr($readonly); ?>>
									</div>
									<div class="input-container input-container-text">
										<label class="input-label"><?php fs_esc_html_echo_inline( 'PayPal account email address', 'paypal-account-email-address', $slug ); ?></label>
										<input id="paypal_email" type="text" value="<?php echo esc_attr( $paypal_email_address ); ?>" class="regular-text" <?php echo esc_attr($readonly); ?>>
									</div>
									<div class="input-container input-container-text">
										...
										<input id="domain" type="text" value="<?php echo esc_attr( $domain ); ?>" class="domain regular-text" <?php echo esc_attr($readonly); ?>>
									...
									<div id="extra_domains_container" class="input-container input-container-text" <?php echo esc_attr($is_pending_affiliate ? '' : 'style="display: none"'); ?>>
										...
										<?php if ( $is_pending_affiliate && ! empty( $extra_domains ) ) : ?>
											<?php foreach ( $extra_domains as $extra_domain ) : ?>
												<div class="extra-domain-input-container">
													<input type="text" value="<?php echo esc_attr( $extra_domain ); ?>" class="domain regular-text" <?php echo esc_attr($readonly); ?>>
												</div>
											<?php endforeach ?>
										<?php endif ?>
									</div>
									...
									<label class="input-label"><nobr><?php fs_esc_html_echo_inline( 'Website, email, and social media statistics (optional)', 'statistics-information-field-label', $slug ); ?></nobr></label>
										<textarea id="statistics_information" rows="5" <?php echo esc_attr($readonly); ?> class="regular-text"><?php echo esc_html($statistics_information); ?></textarea>
										<?php if ( ! $is_affiliate ) : ?>
									...
									<div class="input-container input-container-text">
										...
										<textarea id="promotion_method_description" rows="5" <?php echo esc_attr($readonly); ?> class="regular-text"><?php echo esc_html($promotion_method_description); ?></textarea>
										<?php if ( ! $is_affiliate ) : ?>
									...
									<div>
										...
										<label for="legal_consent_checkbox">I agree to the <a href="<?php echo esc_url($affiliate_program_terms_url); ?>" target="_blank" rel="noopener"><?php esc_html_e('Referrer Program','adminify'); ?></a>'s terms & conditions.</label>
									</div>
									<?php endif ?>
								</form>
							</div>
			...
			jQuery(function ($) {
				...
				$submitButton.click(function (evt) {
					...
					$.ajax({
						...
						method    : 'POST',
						data      : {
							action   : '<?php echo esc_js($fs->get_ajax_action( 'submit_affiliate_application' )); ?>',
							security : '<?php echo esc_js($fs->get_ajax_security( 'submit_affiliate_application' )); ?>',
							module_id: '<?php echo esc_js($module_id); ?>',
							affiliate: affiliate
						},
						beforeSend: function () {
