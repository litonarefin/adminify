...
(function( $ ) {
	$( document ).ready(function() {
		var modalContentHtml = <?php echo json_encode( $modal_content_html ); ?>,
			modalHtml =
				'<div class="fs-modal fs-modal-license-activation fs-modal-license-activation-<?php echo esc_js($unique_affix); ?>">'
			...
			isNetworkActivation             = <?php echo esc_js($is_network_activation ? 'true' : 'false'); ?>,
			isUserChangeSupported           = <?php echo esc_js($is_user_change_supported ? 'true' : 'false'); ?>,
		...
		var
			...
			$otherLicenseKey     = $modal.find( '#other_license_key_<?php echo esc_js($unique_affix); ?>' ),
		...
		var
			...
			afterLicenseUserDataLoaded = function () {
				if (
					...
					otherLicenseOwnerID != <?php echo esc_js($fs->is_registered() ? $fs->get_user()->id : 'null'); ?>
				) {
		...
		function registerEventHandlers() {
			...
			$body.on( 'click', 'span.activate-license.<?php echo esc_js($unique_affix); ?> a, .activate-license-trigger.<?php echo esc_js($unique_affix); ?>', function (evt) {
				evt.preventDefault();
