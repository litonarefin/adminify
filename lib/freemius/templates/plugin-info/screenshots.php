...
<ol>
	...
	foreach ( $screenshots as $s => $url ) :
		?>
			...
			?>
			<li>
				<a href="<?php echo esc_url($url); ?>" title="<?php echo esc_attr( sprintf( fs_text_inline( 'Click to view full-size screenshot %d', 'view-full-size-x', $plugin->slug ), $i ) ); ?>"><img src="<?php echo esc_url($url); ?>"></a>
			</li>
			<?php $i ++; endforeach ?>
</ol>
