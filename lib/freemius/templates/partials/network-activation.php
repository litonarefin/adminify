...
?>
<?php $separator = '<td>|</td>'; ?>
<div class="fs-multisite-options-container fs-apply-on-all-sites"
<?php
...
?>
	...
	<table class="fs-all-sites-options">
		...
		<tr>
			...
			<?php if ( ! $require_license_key ) : ?>
				...
				<?php echo Utils::wp_kses_custom($separator); ?>
	...
	<div class="fs-sites-list-container">
		<table cellspacing="0">
			<tbody>
			<?php $site_props = [ 'uid', 'url', 'title', 'charset', 'language' ]; ?>
			<?php foreach ( $sites as $site ) : ?>
				...
				>
					...
					<?php endif ?>
					<td class="blog-id"><span><?php echo Utils::wp_kses_custom($site['blog_id']); ?></span>.</td>
					<td width="600"><span>
					<?php
