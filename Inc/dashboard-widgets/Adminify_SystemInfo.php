				...
				<table>
					...
					<tr>
						...
						<td>
							...
							<?php } else { ?>
								<strong><?php echo Utils::wp_kses_custom($server_info->get_server_memory_usage()['MemUsageFormat']) . ' ' . esc_html__( 'of', 'adminify' ) . ' ' . $server_info->get_server_memory_usage()['MemLimitFormat']; ?></strong>
								<br>
					...
					<tr>
						<td>
							<a href="<?php echo admin_url( 'admin.php?page=adminify-server-info' ); ?>"><span class="dashicons dashicons-dashboard"></span> <?php esc_html_e( 'Adminify System Info Details', 'adminify' ); ?></a>
						</td>
					</tr>
				</table>
			</div>
