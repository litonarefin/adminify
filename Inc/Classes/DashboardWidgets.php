...
class DashboardWidgets extends AdminSettingsModel
{
    public function __construct()
    {
        ...
        add_action( 'admin_init', array( $this, 'jltwp_adminify_add_hooks' ) );
        add_action( 'plugins_loaded', array( $this, 'jltwp_adminify_dashboard_widgets' ) );
    ...
    public static function render_dashboard_checkboxes()
    {
        ...
        return get_option( 'dashboard_widgets', array() );
    }
