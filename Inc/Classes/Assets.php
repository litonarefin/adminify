...
class Assets extends AdminSettingsModel
{
    ...
    public function __construct()
    {
        ...
        add_action('wp_enqueue_scripts', [$this, 'jltwp_adminify_enqueue_scripts'], 100);
    }
    ...
    public function jltwp_adminify_admin_scripts()
    {
        ...
        wp_register_style('wp-adminify-tokenize2', WP_ADMINIFY_ASSETS . 'vendors/tokenize/tokenize2.min' . Utils::assets_ext('.css'), false, WP_ADMINIFY_VER);
        ...
        wp_register_style('wp-adminify-simple-line-icons', WP_ADMINIFY_ASSETS . 'fonts/simple-line-icons/css/simple-line-icons' . Utils::assets_ext('.css'), false, WP_ADMINIFY_VER);
        wp_register_style('wp-adminify-icomoon', WP_ADMINIFY_ASSETS . 'fonts/icomoon/style' . Utils::assets_ext('.css'), false, WP_ADMINIFY_VER);
        wp_register_style('wp-adminify-themify-icons', WP_ADMINIFY_ASSETS . 'fonts/themify-icons/themify-icons' . Utils::assets_ext('.css'), false, WP_ADMINIFY_VER);


        //Register Scripts
        wp_register_script('wp-adminify-circle-menu', WP_ADMINIFY_ASSETS . 'vendors/circle-menu/jQuery.circleMenu.js', ['jquery'], WP_ADMINIFY_VER, false);
        wp_register_script('wp-adminify-tokenize2', WP_ADMINIFY_ASSETS . 'vendors/tokenize/tokenize2.min.js', ['jquery'], WP_ADMINIFY_VER, false);
        wp_register_script('wp-adminify-admin', WP_ADMINIFY_ASSETS . 'js/wp-adminify.js',  ['jquery'], WP_ADMINIFY_VER, true);
        wp_register_script('wp-adminify-menu-editor', WP_ADMINIFY_ASSETS . 'js/wp-adminify-menu-editor.js',  ['jquery', 'jquery-ui-sortable', 'wp-adminify-icon-picker'], WP_ADMINIFY_VER, true);
        ...
        wp_register_script('wp-adminify-login-customizer-controls', WP_ADMINIFY_ASSETS . 'css/controls' . Utils::assets_ext('.css'), null, WP_ADMINIFY_VER);
        ...
        wp_register_script('wp-adminify-icon-picker', WP_ADMINIFY_ASSETS . 'vendors/adminify-icon-picker/js/adminify-icon-picker.js',  ['jquery'], WP_ADMINIFY_VER, true);
        ...
        wp_enqueue_style('wp-adminify-admin-columns', WP_ADMINIFY_ASSETS . 'admin/css/wp-adminify--admin-columns' . Utils::assets_ext('.css'), ['wp-adminify-themify-icons'], WP_ADMINIFY_VER);
        wp_register_script('wp-adminify-admin-columns', WP_ADMINIFY_ASSETS . 'admin/js/wp-adminify--admin-columns' . Utils::assets_ext('.js'), ['jquery', 'wp-adminify-vue-vendors'], WP_ADMINIFY_VER, true);

        // Adminify Page Speed
        wp_register_script('wp-adminify--page-speed', WP_ADMINIFY_ASSETS . 'admin/js/wp-adminify--page-speed' . Utils::assets_ext('.js'), ['jquery', 'wp-adminify-vue-vendors'], WP_ADMINIFY_VER, true);

        // Adminify Folder
        wp_register_script('wp-adminify--folder', WP_ADMINIFY_ASSETS . 'admin/js/wp-adminify--folder' . Utils::assets_ext('.js'), ['jquery', 'jquery-ui-droppable', 'jquery-ui-draggable', 'wp-adminify-vue-vendors'], WP_ADMINIFY_VER, true);
        ...
        if (jltwp_adminify()->can_use_premium_code__premium_only()) {
            wp_register_style('wp-adminify-pro', WP_ADMINIFY_URL . 'Pro/assets/css/wp-adminify-pro' . Utils::assets_ext('.css'), false, WP_ADMINIFY_VER);
            wp_enqueue_style('wp-adminify-pro');
        }
    ...
    public static function jltwp_adminify_enqueue_scripts()
    {
        ...
        //Scripts
        wp_register_script('wp-adminify-vegas', WP_ADMINIFY_ASSETS . 'vendors/vegas/vegas' . Utils::assets_ext('.js'), ['jquery'], WP_ADMINIFY_VER, true);
        wp_register_script('wp-adminify-vidim', WP_ADMINIFY_ASSETS . 'vendors/vidim/vidim' . Utils::assets_ext('.js'), ['jquery'], WP_ADMINIFY_VER, true);
    }
}
