...
class Adminify_Setup_Wizard
{
    ...
    public function wpadminify_save_wizard_data()
    {
        ...
        if ( !empty($_POST['active_step']) ) {
            $this->step = sanitize_text_field( $_POST['active_step'] );
        }
    ...
    public function setup_wizard_header()
    {
        ...
        ?>" alt="WP Adminify Logo" height="80" width="200">
				</a>
			</h1>
    ...
    public function setup_wizard_steps()
    {
        ...
        foreach ( $output_steps as $step_key => $step ) {
            ...
            ?>">
					<a href="<?php 
            echo  esc_url( admin_url( 'index.php?page=wp-adminify-setup-wizard&step=' . $step_key ) ) ;
            ?>"><?php 
    ...
    public function setup_step_customize()
    {
        ...
        echo  ( !empty($this->options['admin_bar_dark_mode']['admin_bar_dark_logo_text']) ? $this->options['admin_bar_dark_mode']['admin_bar_dark_logo_text'] : '' ) ;
