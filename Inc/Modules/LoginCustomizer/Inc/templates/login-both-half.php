    ...
    <body class="login <?php echo esc_attr(implode(' ', $classes)); ?>">
        ...
        <div class="columns all-centered">
            ...
            <div class="is-half">
                <div id="login">
                    <h1>
                        <a class="wp-adminify-logo-login-link" href="<?php echo esc_url($login_header_url); ?>">
                    ...
                    case 'register':
                        ...
                        if ($http_post) {
                            ...
                            if (isset($_POST['user_email']) && is_string($_POST['user_email'])) {
                                $user_email = wp_unslash(sanitize_email($_POST['user_email']));
                            }

                            $errors = register_new_user($user_login, $user_email);

                            if (!is_wp_error($errors)) {
                                $redirect_to = !empty($_POST['redirect_to']) ? esc_url_raw($_POST['redirect_to']) : 'wp-login.php?checkemail=registered';
                                wp_safe_redirect($redirect_to);
                                exit();
                            }
                        }

                        $registration_redirect = !empty($_REQUEST['redirect_to']) ? esc_url_raw($_REQUEST['redirect_to']) : '';
