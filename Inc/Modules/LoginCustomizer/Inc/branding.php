...
<div class="wp-adminify-badge <?php echo esc_attr( $position_class ) . ' ' . esc_attr( $visibility ); ?>">
	<div class="wp-adminify-badge__inner">
		<span class="wp-adminify-badge__text"><?php _e( 'Powered by', 'adminify' ); ?></span>
		...
		<a class="wp-adminify-badge__link" href="https://wpadminify.com/" alt="<?php echo __( 'Get WP Adminify today', 'adminify' ); ?>" target="_blank"></a>
