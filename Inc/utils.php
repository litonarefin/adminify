...
class Utils
{
    ...
    public static function admin_page_title( $title = '' )
    {
        ...
        if ( is_multisite() ) {
            ...
            ?>
			<?php 
            echo  self::admin_page_subtitle( $text ) ;
            ?>
		<?php 
        }
    ...
    public static function jltwp_adminify_white_label_upgrade()
    {
        ...
        ?>">
			...
			<h2>
				<?php 
        _e( 'Upgrade <span>Pro</span> for White Labeling', 'adminify' );
        ?>
			</h2>
			<p>
				<?php 
    ...
    public static function wp_kses_custom( $content )
    {
        ...
        $custom_tags = [
            ...
            'option'         => self::wp_kses_atts_map( [ 'value' ] ),
